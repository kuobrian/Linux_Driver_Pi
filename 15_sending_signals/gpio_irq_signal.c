...
MODULE_DESCRIPTION("Kernel Module wich sends a signal to an userspace app when GPIO 17 has a rising edge");

#define MYMAJOR 64
/** varible contains pin number o interrupt controller to which GPIO 17 is mapped to */
unsigned int irq_number;

/** Global variables and defines for userspace registration */
